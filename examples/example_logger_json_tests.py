...
class TestJsonLogger(unittest.TestCase):
    def setUp(self):
        self.tune_logger = logging.getLogger('logging-test')
        self.tune_logger.setLevel(logging.DEBUG)
        self.buffer = StringIO()

        self.logHandler = logging.StreamHandler(self.buffer)
        self.tune_logger.addHandler(self.logHandler)
    ...
    def testLogExtra(self):
        ...
        self.tune_logger.info("hello", extra=extra)
        logJson = json.loads(self.buffer.getvalue())
    ...
    def testJsonDefaultEncoder(self):
        ...
        self.assertEqual(logJson.get("otherdatetimeagain"), "1900-01-01T00:00")
    ...
    def testExcInfo(self):
        ...
        try:
            ...
            self.tune_logger.exception("hello")
